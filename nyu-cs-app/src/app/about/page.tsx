      ...
      <section className="section">
        <div className="container">
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            >
              Our faculty are leaders in their fields, receiving numerous awards
              and honors. We offer a wide range of undergraduate and graduate
              programs, including degrees in Computer Science, Data Science, and
              Information Systems.
            </p>
            <p style={{ fontSize: "1.1rem", lineHeight: "1.8" }}>
              We are committed to fostering a diverse and inclusive community
              where students from all backgrounds can thrive and innovate.
            </p>

            <p>We are the ultimate monster</p>
          </div>
        </div>
      </section>
    </div>
